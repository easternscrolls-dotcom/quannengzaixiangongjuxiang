...
const THEME_DATA = [
    ...
    {idx:5, subCate:['light'], zh:'清新浅色博客主题', en:'Fresh Light Blog Theme',
     ...
     previewUrl:'#', downloadUrl:'#'},
    {idx:6, subCate:['blog'], zh:'杂志风多栏博客主题', en:'Magazine Multi-column Blog Theme',
     desc_zh:'首页杂志网格布局，特色文章大图，侧边热门榜单，适合内容站。',
     desc_en:'Magazine grid homepage, featured hero image, sidebar hot list, for content sites.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:7, subCate:['blog'], zh:'双栏学术博客主题', en:'Two-column Academic Blog Theme',
     desc_zh:'正文双栏排版，目录锚点导航，代码高亮与公式支持，适合技术博客。',
     desc_en:'Two-column body, TOC anchor nav, code highlight & math support, for tech blogs.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:8, subCate:['homepage'], zh:'开发者个人主页模板', en:'Developer Personal Homepage',
     desc_zh:'GitHub 风格个人主页，技能雷达图、项目卡片、博客聚合一体化。',
     desc_en:'GitHub-style homepage with skill radar, project cards and blog aggregation.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:9, subCate:['homepage'], zh:'摄影师作品集模板', en:'Photographer Portfolio Template',
     desc_zh:'全屏图库瀑布流，灯箱预览，关于与预约模块，视觉优先。',
     desc_en:'Fullscreen masonry gallery, lightbox preview, about & booking modules.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:10, subCate:['toolpage'], zh:'极简工具箱首页', en:'Minimal Toolkit Homepage',
     desc_zh:'单页工具聚合，顶部搜索 + 分类磁贴，零依赖纯静态。',
     desc_en:'Single-page tool aggregator, top search + category tiles, zero-dependency static.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:11, subCate:['toolpage'], zh:'多工具导航中心', en:'Multi-tool Nav Hub',
     desc_zh:'左侧分组导航 + 右侧工具面板，支持暗黑模式与快捷键。',
     desc_en:'Left grouped nav + right tool panel, dark mode and hotkeys supported.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:12, subCate:['dark'], zh:'赛博朋克暗黑主题', en:'Cyberpunk Dark Theme',
     desc_zh:'霓虹描边与故障特效，深色护眼，适合极客与资源站。',
     desc_en:'Neon outlines and glitch effects, eye-friendly dark, for geeks & resource sites.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:13, subCate:['dark'], zh:'深空暗黑资源站', en:'Deep Space Dark Resource',
     desc_zh:'星空背景渐变，毛玻璃卡片，分类筛选动效流畅。',
     desc_en:'Starfield gradient bg, glassmorphism cards, smooth filter animations.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:14, subCate:['light'], zh:'薄荷绿清新主题', en:'Mint Fresh Theme',
     desc_zh:'低饱和薄荷配色，圆角大留白，加载轻盈，适合女性/生活类站点。',
     desc_en:'Low-saturation mint palette, rounded airy whitespace, light load, for lifestyle sites.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:15, subCate:['light'], zh:'商务浅色官网模板', en:'Business Light Corporate',
     desc_zh:'蓝白商务风，首页轮播 + 服务卡片 + 客户案例，转化导向。',
     desc_en:'Blue-white corporate style, hero carousel + service cards + cases, conversion-focused.',
     previewUrl:'#', downloadUrl:'#'}
];
...
const SOURCE_DATA = [
    ...
    {idx:5, subCate:['newsrc'], zh:'企业官网源码', en:'Corporate Site Source',
     ...
     previewUrl:'#', downloadUrl:'#'},
    {idx:6, subCate:['blogsrc'], zh:'Hexo 博客站源码', en:'Hexo Blog Source',
     desc_zh:'基于 Node 的静态博客框架，主题丰富，支持 Markdown 与插件生态。',
     desc_en:'Node-based static blog framework, rich themes, Markdown & plugin ecosystem.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:7, subCate:['blogsrc'], zh:'Astro 内容站源码', en:'Astro Content Source',
     desc_zh:'群岛架构极速渲染，组件化写博客，默认零 JS 加载极快。',
     desc_en:'Islands architecture, component-driven blogging, zero-JS by default, blazing fast.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:8, subCate:['navsrc'], zh:'书签导航站源码', en:'Bookmark Nav Source',
     desc_zh:'可视化编辑网址书签，分组拖拽排序，本地存储免后端。',
     desc_en:'Visual bookmark editor, drag-to-sort groups, local storage, no backend.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:9, subCate:['navsrc'], zh:'网址收藏夹源码', en:'URL Collector Source',
     desc_zh:'一键收藏当前页，标签归类与全文搜索，支持浏览器导入。',
     desc_en:'One-click save current page, tag grouping & full-text search, browser import ready.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:10, subCate:['toolsrc'], zh:'前端工具集合源码', en:'Frontend Toolset Source',
     desc_zh:'纯前端实现 30+ 实用小工具，PWA 可离线，无需服务器。',
     desc_en:'Pure-frontend 30+ utilities, PWA offline support, no server required.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:11, subCate:['toolsrc'], zh:'在线工具箱源码', en:'Online Toolkit Source',
     desc_zh:'模块化工具注册，新增工具零配置，内置国际化与暗黑模式。',
     desc_en:'Modular tool registry, zero-config new tools, built-in i18n & dark mode.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:12, subCate:['newsrc'], zh:'聚合资讯站源码', en:'Aggregator News Source',
     desc_zh:'RSS/API 多源聚合，自动去重与分类，定时抓取更新。',
     desc_en:'RSS/API multi-source aggregation, auto-dedup & categorize, scheduled fetch.',
     previewUrl:'#', downloadUrl:'#'},
    {idx:13, subCate:['newsrc'], zh:'技术周刊站源码', en:'Tech Weekly Source',
     desc_zh:'周刊归档 + 邮件订阅 + 标签云，轻量静态生成。',
     desc_en:'Weekly archive + email subscribe + tag cloud, lightweight static generation.',
     previewUrl:'#', downloadUrl:'#'}
];
